...
public class OutputPortProcessorTester {
	public static boolean run(){
		...
		target.put("OutputPort1", SymbolTable.newPair(SymbolType.OUTPUT_PORT, OutputPort1));
		...
		target.put("OutputPort2", SymbolTable.newPair(SymbolType.OUTPUT_PORT, OutputPort2));
		...
		target.put("i1", SymbolTable.newPair(SymbolType.OUTPUT_PORT, i1));
